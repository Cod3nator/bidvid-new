...
const About_us = () => {
  const teamMembers = [
    { name: 'Rajkumar Remalli', title: 'Founder & CEO', image: '/about-us/rajkumar.png' },
    { name: 'Amarnath', title: 'Head of Programmatic', image: '/about-us/amarnath.png' },
    { name: 'Alok Shenoy', title: 'Co-founder & CTO', image: '/about-us/alok.png' },
    { name: 'Shreya R', title: 'Manager Australia', image: '/about-us/shreya.png' },
    { name: 'Bryan Edwin', title: 'Client Services', image: '/about-us/bryan.png' },
    { name: 'Manish Parwal', title: 'Director', image: '/about-us/manish.png' },
    { name: 'Anujita Jain', title: 'Director', image: '/about-us/anujita.png' },
  ];
      ...
      <div className="container">
        <div className="about-us-detail">
          <div className="custom-box">
            ...
            <img src="/about-us/some.png" alt="Left Image" className="custom-box-image" />
          </div>
          <div className="custom-box">
            <h2>Our Vision</h2>
            ...
            <img src="/about-us/some.png" alt="Right Image" className="custom-box-image" />
          </div>
        </div>
      </div>
